        ...
        try {
            if (guild) {
                ...
                const customizationsEmbed = new discord_js_1.MessageEmbed()
                    ...
                    .addFields({ name: 'ETH Address', value: result.address }, { name: 'Token ID', value: `${result.token_id}` }, { name: 'Customizations', value: result.customizations }, { name: 'Last Updated', value: result.updatedDateTimeUtc });
...
//# sourceMappingURL=get-custom-mylo.js.map